...
public class ScrollViewAttachmentInventoryScreen extends AbstractContainerScreen<ScrollViewMenu> {
    ...
    public static void handlePearlClicked(@NotNull Minecraft mc) {
        try {
            ...
            if (parent != null) {
                mc.setScreen(new ScrollViewAttachmentInventoryScreen(menu, mc.player.getInventory(), Component.empty(), parent));
            } else {
                mc.setScreen(new ScrollViewAttachmentInventoryScreen(menu, mc.player.getInventory(), Component.empty()));
            }
