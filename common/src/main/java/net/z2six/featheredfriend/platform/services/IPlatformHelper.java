...
public interface IPlatformHelper {
    ...
    /**
     * Open the scroll view screen (placeholder) for sealed / opened scrolls.
     * Called from ScrollViewItem#use on the logical server.
     */
    void openScrollViewScreen(ServerPlayer player);
