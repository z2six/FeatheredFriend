...
public final class RavenVisuals {
    ...
    private static final ResourceLocation TEX_LEATHER =
            ResourceLocation.fromNamespaceAndPath(MODID, "textures/entity/raven_leather.png");
    private static final ResourceLocation TEX_COPPER =
            ResourceLocation.fromNamespaceAndPath(MODID, "textures/entity/raven_copper.png");
    private static final ResourceLocation TEX_IRON =
            ResourceLocation.fromNamespaceAndPath(MODID, "textures/entity/raven_iron.png");
    private static final ResourceLocation TEX_GOLD =
            ResourceLocation.fromNamespaceAndPath(MODID, "textures/entity/raven_gold.png");
    private static final ResourceLocation TEX_DIAMOND =
            ResourceLocation.fromNamespaceAndPath(MODID, "textures/entity/raven_diamond.png");
    private static final ResourceLocation TEX_NETHERITE =
            ResourceLocation.fromNamespaceAndPath(MODID, "textures/entity/raven_netherite.png");
