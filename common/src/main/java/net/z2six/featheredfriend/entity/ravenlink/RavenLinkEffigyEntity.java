...
public class RavenLinkEffigyEntity extends PathfinderMob {
    ...
    protected void defineSynchedData() {
        ...
        this.entityData.define(DATA_HAS_POSE_SNAPSHOT, false);
        this.entityData.define(DATA_HEAD_XROT, 0.0F);
        this.entityData.define(DATA_HEAD_YROT, 0.0F);
        this.entityData.define(DATA_HEAD_ZROT, 0.0F);
        this.entityData.define(DATA_BODY_XROT, 0.0F);
        this.entityData.define(DATA_BODY_YROT, 0.0F);
        this.entityData.define(DATA_BODY_ZROT, 0.0F);
        this.entityData.define(DATA_RIGHT_ARM_XROT, 0.0F);
        this.entityData.define(DATA_RIGHT_ARM_YROT, 0.0F);
        this.entityData.define(DATA_RIGHT_ARM_ZROT, 0.0F);
        this.entityData.define(DATA_LEFT_ARM_XROT, 0.0F);
        this.entityData.define(DATA_LEFT_ARM_YROT, 0.0F);
        this.entityData.define(DATA_LEFT_ARM_ZROT, 0.0F);
        this.entityData.define(DATA_RIGHT_LEG_XROT, 0.0F);
        this.entityData.define(DATA_RIGHT_LEG_YROT, 0.0F);
        this.entityData.define(DATA_RIGHT_LEG_ZROT, 0.0F);
        this.entityData.define(DATA_LEFT_LEG_XROT, 0.0F);
        this.entityData.define(DATA_LEFT_LEG_YROT, 0.0F);
        this.entityData.define(DATA_LEFT_LEG_ZROT, 0.0F);
    }
