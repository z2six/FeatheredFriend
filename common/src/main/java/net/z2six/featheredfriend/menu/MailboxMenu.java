...
/**
 * Mailbox block menu (8 slots) backed by the mailbox block entity.
 */
public class MailboxMenu extends AbstractContainerMenu {
    ...
    private static final int MAILBOX_COLS = 8;
    ...
    private void initSlots() {
        ...
        // Player inventory positioning matches vanilla container layout, adjusted for MAILBOX_ROWS.
        int playerInvY = 84 - (3 - MAILBOX_ROWS) * 18;
        int hotbarY = 142 - (3 - MAILBOX_ROWS) * 18;
