...
public final class FFClientConfig {
    ...
    public static final ForgeConfigSpec.ConfigValue<String> SCROLL_UI_FONT_MODE;
    public static final ForgeConfigSpec.ConfigValue<String> RAVEN_STATUS_GUI_VISUAL_MODE;
    public static final ForgeConfigSpec.BooleanValue USE_VANILLA_FONT_FOR_GOTHIC_TEXT;
    public static final ForgeConfigSpec.ConfigValue<String> FAVORITE_STAMP_KEY;
    public static final ForgeConfigSpec.ConfigValue<String> RAVEN_LOG_VIEW_SETTINGS_RAW;
    public static final ForgeConfigSpec.IntValue RAVEN_STATUS_GUI_X;
    public static final ForgeConfigSpec.IntValue RAVEN_STATUS_GUI_Y;
    public static final ForgeConfigSpec.ConfigValue<String> RAVEN_STATUS_GUI_ANCHOR;
